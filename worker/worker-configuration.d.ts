/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts --config worker/wrangler.jsonc --env-interface CloudflareBindings` (hash: 1334d05996aa872da0e2db3b293b9e21)
// Runtime types generated with workerd@1.20260515.1 2026-05-22 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	MATCH_ROOMS: DurableObjectNamespace<import("./index").KeepstormMatchRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "KeepstormMatchRoom";
	}
