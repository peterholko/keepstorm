...
export const BUILDING_SPECS = {
  ...
  dawn_tally: { name: "Tallyhouse", faction: "daybreak", category: "economy", cohort: null, cost: { marks: 350, timber: 500 }, upgradeCost: { marks: 190, timber: 30 }, legendaryCost: { marks: 310, timber: 80 }, width: 2, height: 2, maxHp: 430, spawnEvery: null, unitKind: null, yieldBonus: 24, timberGain: 16, atlasIndex: 6, effect: "income", description: "Amplifies all income by 25%; each additional Tallyhouse adds 85% of the previous bonus." },
  ...
  briar_hollow: troop({ name: "Bark Hollow", faction: "briarcrown", cohort: "Barkmauls", cost: { marks: 112 }, upgradeCost: { marks: 150 }, legendaryCost: { marks: 280, timber: 110, sigils: 1 }, width: 3, height: 3, maxHp: 720, spawnEvery: 15, unitKind: "barkmaul", yieldBonus: 4, timberGain: 20, atlasIndex: 0, description: "Regenerating Hammer tanks with exceptional staying power." }),
  briar_sporecourt: troop({ name: "Sporecourt", faction: "briarcrown", cohort: "Thorncasters", cost: { marks: 122 }, upgradeCost: { marks: 160 }, legendaryCost: { marks: 295, timber: 118, sigils: 1 }, width: 3, height: 3, maxHp: 550, spawnEvery: 13, unitKind: "thorncaster", yieldBonus: 5, timberGain: 22, atlasIndex: 1, description: "Poisoning Arrow cohorts that excel in prolonged fights." }),
  briar_mirepool: troop({ name: "Mire Oracle", faction: "briarcrown", cohort: "Bogseers", cost: { marks: 148 }, upgradeCost: { marks: 182 }, legendaryCost: { marks: 330, timber: 132, sigils: 1 }, width: 3, height: 3, maxHp: 520, spawnEvery: 16, unitKind: "bogseer", yieldBonus: 6, timberGain: 24, atlasIndex: 2, description: "Arc casters that slow enemy movement and attack cadence." }),
  briar_mothery: troop({ name: "Gloom Mothery", faction: "briarcrown", cohort: "Gloomwings", cost: { marks: 168 }, upgradeCost: { marks: 205 }, legendaryCost: { marks: 355, timber: 145, sigils: 1 }, width: 3, height: 3, maxHp: 480, spawnEvery: 17, unitKind: "gloomwing", yieldBonus: 7, timberGain: 26, atlasIndex: 3, description: "Flying Arc predators that drain life from their targets." }),
  briar_rootcannon: troop({ name: "Rootcannon", faction: "briarcrown", cohort: "Rootbreakers", cost: { marks: 210 }, upgradeCost: { marks: 238 }, legendaryCost: { marks: 395, timber: 165, sigils: 1 }, width: 3, height: 3, maxHp: 680, spawnEvery: 22, unitKind: "rootbreaker", yieldBonus: 8, timberGain: 12, atlasIndex: 4, description: "Fortified living artillery that sends roots through formations." }),
  ...
  briar_sapvault: { name: "Sapvault", faction: "briarcrown", category: "economy", cohort: null, cost: { marks: 350, timber: 500 }, upgradeCost: { marks: 188, timber: 30 }, legendaryCost: { marks: 305, timber: 78 }, width: 2, height: 2, maxHp: 470, spawnEvery: null, unitKind: null, yieldBonus: 23, timberGain: 18, atlasIndex: 6, effect: "income", description: "Amplifies all income by 25%; each additional Sapvault adds 85% of the previous bonus." },
  ...
  storm_coilforge: troop({ name: "Coilforge", faction: "stormglass", cohort: "Voltstriders", cost: { marks: 108 }, upgradeCost: { marks: 148 }, legendaryCost: { marks: 278, timber: 108, sigils: 1 }, width: 3, height: 3, maxHp: 640, spawnEvery: 13, unitKind: "voltstrider", yieldBonus: 4, timberGain: 20, atlasIndex: 0, description: "Fast Hammer troops whose charged blows can stun." }),
  storm_prismary: troop({ name: "Prismary", faction: "stormglass", cohort: "Glassbolts", cost: { marks: 128 }, upgradeCost: { marks: 168 }, legendaryCost: { marks: 305, timber: 120, sigils: 1 }, width: 3, height: 3, maxHp: 510, spawnEvery: 12, unitKind: "glassbolt", yieldBonus: 5, timberGain: 22, atlasIndex: 1, description: "Very fast Arrow fire from fragile long-range cohorts." }),
  storm_chronowell: troop({ name: "Chronowell", faction: "stormglass", cohort: "Timebinders", cost: { marks: 152 }, upgradeCost: { marks: 188 }, legendaryCost: { marks: 336, timber: 134, sigils: 1 }, width: 3, height: 3, maxHp: 500, spawnEvery: 16, unitKind: "timebinder", yieldBonus: 6, timberGain: 24, atlasIndex: 2, description: "Arc support that accelerates nearby allied attack cycles." }),
  storm_nimbus: troop({ name: "Nimbus Dock", faction: "stormglass", cohort: "Stormrays", cost: { marks: 174 }, upgradeCost: { marks: 210 }, legendaryCost: { marks: 360, timber: 148, sigils: 1 }, width: 3, height: 3, maxHp: 455, spawnEvery: 18, unitKind: "stormray", yieldBonus: 7, timberGain: 26, atlasIndex: 3, description: "Flying Arc hunters with chain lightning attacks." }),
  storm_railworks: troop({ name: "Railworks", faction: "stormglass", cohort: "Railthunders", cost: { marks: 215 }, upgradeCost: { marks: 245 }, legendaryCost: { marks: 405, timber: 170, sigils: 1 }, width: 3, height: 3, maxHp: 600, spawnEvery: 23, unitKind: "railthunder", yieldBonus: 8, timberGain: 12, atlasIndex: 4, description: "The longest-ranged Siege cohort, built to erase dense waves." }),
  ...
  storm_measurehouse: { name: "Measurehouse", faction: "stormglass", category: "economy", cohort: null, cost: { marks: 350, timber: 500 }, upgradeCost: { marks: 194, timber: 32 }, legendaryCost: { marks: 315, timber: 82 }, width: 2, height: 2, maxHp: 420, spawnEvery: null, unitKind: null, yieldBonus: 25, timberGain: 15, atlasIndex: 6, effect: "income", description: "Amplifies all income by 25%; each additional Measurehouse adds 85% of the previous bonus." },
...
export interface FactionKeepArtSpec {
  src: string;
  index: number;
  rows: number;
  columns: number;
...
export interface FactionSpec {
  ...
  description: string;
  atlas: string;
  keep: FactionKeepArtSpec;
  buildings: readonly BuildingKind[];
}

export const FACTIONS: Record<FactionId, FactionSpec> = {
  daybreak: { id: "daybreak", name: "Daybreak Company", epithet: "Formation & protection", crest: "D", emblem: "/game/factions/daybreak-emblem-v1.png", color: "#f0bd48", accent: "#d34a2d", passive: "Ordered Ranks: nearby allies share 10% damage resistance.", description: "A balanced host of durable fronts, accurate ranged fire, air support, and protective engineering.", atlas: "/game/daybreak-depth-atlas-magenta-v1.png", keep: { src: "/game/daybreak-atlas-magenta-v1.png", index: 0, rows: 2, columns: 4 }, buildings: ["dawn_bastion", "dawn_quillery", "dawn_beacon", "dawn_aerie", "dawn_bombard", "dawn_aegis", "dawn_tally", "dawn_sunlance"] },
  briarcrown: { id: "briarcrown", name: "Briarcrown Covenant", epithet: "Regrowth & attrition", crest: "B", emblem: "/game/factions/briarcrown-emblem-v1.png", color: "#9bc95a", accent: "#d99145", passive: "Deep Roots: every living cohort regenerates health each second.", description: "A patient living army built around regeneration, poison, slowing magic, and fortified siege beasts.", atlas: "/game/briarcrown-depth-atlas-magenta-v1.png", keep: { src: "/game/factions/briarcrown-keep-v1.png", index: 0, rows: 1, columns: 1 }, buildings: ["briar_hollow", "briar_sporecourt", "briar_mirepool", "briar_mothery", "briar_rootcannon", "briar_heartgrove", "briar_sapvault", "briar_thornspire"] },
  stormglass: { id: "stormglass", name: "Stormglass Collegium", epithet: "Tempo & disruption", crest: "S", emblem: "/game/factions/stormglass-emblem-v1.png", color: "#71e9c3", accent: "#6b78db", passive: "Quick Current: production and attack cycles run 8% faster.", description: "A volatile technical force of rapid fire, stuns, chain lightning, flight, and long-range artillery.", atlas: "/game/stormglass-depth-atlas-magenta-v1.png", keep: { src: "/game/factions/stormglass-keep-v1.png", index: 0, rows: 1, columns: 1 }, buildings: ["storm_coilforge", "storm_prismary", "storm_chronowell", "storm_nimbus", "storm_railworks", "storm_static_spire", "storm_measurehouse", "storm_arctower"] },
};
